...
namespace UWPSoundBoard
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void SearchAutoSuggesBox_OnTextChanged(AutoSuggestBox sender, AutoSuggestBoxTextChangedEventArgs args)
        {
            throw new NotImplementedException();
        }

        private void SearchAutoSuggesBox_OnQuerySubmitted(AutoSuggestBox sender, AutoSuggestBoxQuerySubmittedEventArgs args)
        {
            throw new NotImplementedException();
        }
